...
13. **Примітка про "Автопас":** Для пришвидшення гри в режимі **двох гравців** реалізовано механіку "автопасу". Якщо після того, як захисник побив карту, у головного атакуючого більше немає карт для підкидання, раунд автоматично завершується, і хід передається далі. У грі на 3+ гравців ця механіка **не діє**, щоб дати можливість іншим гравцям підкинути свої карти.

14. **Принцип Пріоритету Документації:** Моїм першочерговим і найважливішим завданням перед виконанням будь-якого запиту є ознайомлення з актуальним контекстом. Я *завжди* починаю з аналізу файлу `documentation/instructions.md`, особливо якщо запит стосується зміни коду, аналізу помилок або планування дій.
...
Зміна теми відбувається миттєво і буде застосована до всіх наступніх дій в грі в цьому чаті.
