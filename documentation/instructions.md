...
*   **Хто може використовувати:** Тільки творець гри.
*   **Як використовувати:**
...
*   `durak/`: Главный пакет, содержащий всю бизнес-логику игры "Дурак".
    ...
    *   `handlers/`: Обработчики команд и callback-запросов от пользователей в Telegram.
        *   `game_mode.py`: Реалізує команду `/gamemode`, що дозволяє творцю гри змінювати режим відображення (напр. `text` або `text_and_sticker`).
