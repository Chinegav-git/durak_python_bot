...
2. По завершении работы над задачей, обнови файл `CHANGELOG.md`, чтобы отразить все внесенные изменения (новые функции, исправления, обновления документации).
...
5. При добавлении нового функционала или изменении существующего, всегда обновляй сопутствующую документацию (например, в файле `documentation/instructions.md`), чтобы она отражала внесенные изменения.
