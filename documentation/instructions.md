...
7.  **Принцип финальной само-верификации:** Перед тем как объявить задачу выполненной, я обязан провести внутреннюю проверку по следующему чеклисту, чтобы гарантировать качество и полноту работы:
    ...
    *   `[ ]` **Стиль соблюден?** Соответствует ли мой код стандартам (правило №5)? Соответствуют ли мои записи в `CHANGELOG.md` стилю предыдущих записей (правило №6)?
    *   `[ ]` **Все инструкции выполнены?** Перечитал ли я правила с №1 по №6 и убедился ли, что все они выполнены?
