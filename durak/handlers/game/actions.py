...
async def process_text_action_handler(message: types.Message, gm: GameManager, l: I18n):
    ...
    и, сравнивая их с шаблонами из файлов локализации, вызывает
    соответствующую игровую логику.
    
    GAME ACTION HANDLER.

    Intercepts text messages generated by the inline mode and, by comparing
    them with templates from localization files, calls the corresponding
    game logic.
    """
